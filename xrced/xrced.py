...
# Created:      20.08.2001
# RCS-ID:       $Id: xrced.py,v 1.49 2007/03/07 14:45:11 ROL Exp $
...
Please upgrade wxWidgets to %d.%d.%d or higher.''' % MinWxVersion)
        ...
        pos = (150,150)  # conf.ReadInt('x', -1), conf.ReadInt('y', -1)
