...
def getAutoRefreshBitmap():
    return wx.Bitmap(getAutoRefreshImage())

def getAutoRefreshImage():
    stream = BytesIO(getAutoRefreshData())
...
def getIconBitmap():
    return wx.Bitmap(getIconImage())

def getIconImage():
    stream = BytesIO(getIconData())
    return wx.Image(stream)
...
def getLocateBitmap():
    return wx.Bitmap(getLocateImage())

def getLocateImage():
    stream = BytesIO(getLocateData())
    return wx.Image(stream)
...
def getLocateArmedBitmap():
    return wx.Bitmap(getLocateArmedImage())

def getLocateArmedImage():
    stream = BytesIO(getLocateArmedData())
    return wx.Image(stream)
...
def getRefreshBitmap():
    return wx.Bitmap(getRefreshImage())

def getRefreshImage():
    stream = BytesIO(getRefreshData())
    return wx.Image(stream)
...
def getTestBitmap():
    return wx.Bitmap(getTestImage())

def getTestImage():
    stream = BytesIO(getTestData())
    return wx.Image(stream)
...
def getToolBitmapButtonBitmap():
    return wx.Bitmap(getToolBitmapButtonImage())

def getToolBitmapButtonImage():
    stream = BytesIO(getToolBitmapButtonData())
    return wx.Image(stream)
...
def getToolBoxSizerBitmap():
    return wx.Bitmap(getToolBoxSizerImage())

def getToolBoxSizerImage():
    stream = BytesIO(getToolBoxSizerData())
    return wx.Image(stream)
...
def getToolButtonBitmap():
    return wx.Bitmap(getToolButtonImage())

def getToolButtonImage():
    stream = BytesIO(getToolButtonData())
    return wx.Image(stream)
...
def getToolCheckBoxBitmap():
    return wx.Bitmap(getToolCheckBoxImage())

def getToolCheckBoxImage():
    stream = BytesIO(getToolCheckBoxData())
    return wx.Image(stream)
...
def getToolCheckListBitmap():
    return wx.Bitmap(getToolCheckListImage())

def getToolCheckListImage():
    stream = BytesIO(getToolCheckListData())
    return wx.Image(stream)
...
def getToolChoiceBitmap():
    return wx.Bitmap(getToolChoiceImage())

def getToolChoiceImage():
    stream = BytesIO(getToolChoiceData())
    return wx.Image(stream)
...
def getToolComboBoxBitmap():
    return wx.Bitmap(getToolComboBoxImage())

def getToolComboBoxImage():
    stream = BytesIO(getToolComboBoxData())
    return wx.Image(stream)
...
def getToolDefaultBitmap():
    return wx.Bitmap(getToolDefaultImage())

def getToolDefaultImage():
    stream = BytesIO(getToolDefaultData())
    return wx.Image(stream)
...
def getToolDialogBitmap():
    return wx.Bitmap(getToolDialogImage())

def getToolDialogImage():
    stream = BytesIO(getToolDialogData())
    return wx.Image(stream)
...
def getToolFlexGridSizerBitmap():
    return wx.Bitmap(getToolFlexGridSizerImage())

def getToolFlexGridSizerImage():
    stream = BytesIO(getToolFlexGridSizerData())
    return wx.Image(stream)
...
def getToolFrameBitmap():
    return wx.Bitmap(getToolFrameImage())

def getToolFrameImage():
    stream = BytesIO(getToolFrameData())
    return wx.Image(stream)
...
def getToolGaugeBitmap():
    return wx.Bitmap(getToolGaugeImage())

def getToolGaugeImage():
    stream = BytesIO(getToolGaugeData())
    return wx.Image(stream)
...
def getToolGridBagSizerBitmap():
    return wx.Bitmap(getToolGridBagSizerImage())

def getToolGridBagSizerImage():
    stream = BytesIO(getToolGridBagSizerData())
    return wx.Image(stream)
...
def getToolGridSizerBitmap():
    return wx.Bitmap(getToolGridSizerImage())

def getToolGridSizerImage():
    stream = BytesIO(getToolGridSizerData())
    return wx.Image(stream)
...
def getToolListBoxBitmap():
    return wx.Bitmap(getToolListBoxImage())

def getToolListBoxImage():
    stream = BytesIO(getToolListBoxData())
    return wx.Image(stream)
...
def getToolListCtrlBitmap():
    return wx.Bitmap(getToolListCtrlImage())

def getToolListCtrlImage():
    stream = BytesIO(getToolListCtrlData())
    return wx.Image(stream)
...
def getToolMenuBitmap():
    return wx.Bitmap(getToolMenuImage())

def getToolMenuImage():
    stream = BytesIO(getToolMenuData())
    return wx.Image(stream)
...
def getToolMenuBarBitmap():
    return wx.Bitmap(getToolMenuBarImage())

def getToolMenuBarImage():
    stream = BytesIO(getToolMenuBarData())
    return wx.Image(stream)
...
def getToolMenuItemBitmap():
    return wx.Bitmap(getToolMenuItemImage())

def getToolMenuItemImage():
    stream = BytesIO(getToolMenuItemData())
    return wx.Image(stream)
...
def getToolMoveDownBitmap():
    return wx.Bitmap(getToolMoveDownImage())

def getToolMoveDownImage():
    stream = BytesIO(getToolMoveDownData())
    return wx.Image(stream)
...
def getToolMoveLeftBitmap():
    return wx.Bitmap(getToolMoveLeftImage())

def getToolMoveLeftImage():
    stream = BytesIO(getToolMoveLeftData())
    return wx.Image(stream)
...
def getToolMoveRightBitmap():
    return wx.Bitmap(getToolMoveRightImage())

def getToolMoveRightImage():
    stream = BytesIO(getToolMoveRightData())
    return wx.Image(stream)
...
def getToolMoveUpBitmap():
    return wx.Bitmap(getToolMoveUpImage())

def getToolMoveUpImage():
    stream = BytesIO(getToolMoveUpData())
    return wx.Image(stream)
...
def getToolNotebookBitmap():
    return wx.Bitmap(getToolNotebookImage())

def getToolNotebookImage():
    stream = BytesIO(getToolNotebookData())
    return wx.Image(stream)
...
def getToolPanelBitmap():
    return wx.Bitmap(getToolPanelImage())

def getToolPanelImage():
    stream = BytesIO(getToolPanelData())
    return wx.Image(stream)
...
def getToolRadioBoxBitmap():
    return wx.Bitmap(getToolRadioBoxImage())

def getToolRadioBoxImage():
    stream = BytesIO(getToolRadioBoxData())
    return wx.Image(stream)
...
def getToolRadioButtonBitmap():
    return wx.Bitmap(getToolRadioButtonImage())

def getToolRadioButtonImage():
    stream = BytesIO(getToolRadioButtonData())
    return wx.Image(stream)
...
def getToolRootBitmap():
    return wx.Bitmap(getToolRootImage())

def getToolRootImage():
    stream = BytesIO(getToolRootData())
    return wx.Image(stream)
...
def getToolScrollBarBitmap():
    return wx.Bitmap(getToolScrollBarImage())

def getToolScrollBarImage():
    stream = BytesIO(getToolScrollBarData())
    return wx.Image(stream)
...
def getToolSeparatorBitmap():
    return wx.Bitmap(getToolSeparatorImage())

def getToolSeparatorImage():
    stream = BytesIO(getToolSeparatorData())
    return wx.Image(stream)
...
def getToolSliderBitmap():
    return wx.Bitmap(getToolSliderImage())

def getToolSliderImage():
    stream = BytesIO(getToolSliderData())
    return wx.Image(stream)
...
def getToolSpacerBitmap():
    return wx.Bitmap(getToolSpacerImage())

def getToolSpacerImage():
    stream = BytesIO(getToolSpacerData())
    return wx.Image(stream)
...
def getToolSpinButtonBitmap():
    return wx.Bitmap(getToolSpinButtonImage())

def getToolSpinButtonImage():
    stream = BytesIO(getToolSpinButtonData())
    return wx.Image(stream)
...
def getToolSpinCtrlBitmap():
    return wx.Bitmap(getToolSpinCtrlImage())

def getToolSpinCtrlImage():
    stream = BytesIO(getToolSpinCtrlData())
    return wx.Image(stream)
...
def getToolSplitterWindowBitmap():
    return wx.Bitmap(getToolSplitterWindowImage())

def getToolSplitterWindowImage():
    stream = BytesIO(getToolSplitterWindowData())
    return wx.Image(stream)
...
def getToolStaticBitmapBitmap():
    return wx.Bitmap(getToolStaticBitmapImage())

def getToolStaticBitmapImage():
    stream = BytesIO(getToolStaticBitmapData())
    return wx.Image(stream)
...
def getToolStaticBoxBitmap():
    return wx.Bitmap(getToolStaticBoxImage())

def getToolStaticBoxImage():
    stream = BytesIO(getToolStaticBoxData())
    return wx.Image(stream)
...
def getToolStaticBoxSizerBitmap():
    return wx.Bitmap(getToolStaticBoxSizerImage())

def getToolStaticBoxSizerImage():
    stream = BytesIO(getToolStaticBoxSizerData())
    return wx.Image(stream)
...
def getToolStaticLineBitmap():
    return wx.Bitmap(getToolStaticLineImage())

def getToolStaticLineImage():
    stream = BytesIO(getToolStaticLineData())
    return wx.Image(stream)
...
def getToolStaticTextBitmap():
    return wx.Bitmap(getToolStaticTextImage())

def getToolStaticTextImage():
    stream = BytesIO(getToolStaticTextData())
    return wx.Image(stream)
...
def getToolTextCtrlBitmap():
    return wx.Bitmap(getToolTextCtrlImage())

def getToolTextCtrlImage():
    stream = BytesIO(getToolTextCtrlData())
    return wx.Image(stream)
...
def getToolToolBitmap():
    return wx.Bitmap(getToolToolImage())

def getToolToolImage():
    stream = BytesIO(getToolToolData())
    return wx.Image(stream)
...
def getToolToolBarBitmap():
    return wx.Bitmap(getToolToolBarImage())

def getToolToolBarImage():
    stream = BytesIO(getToolToolBarData())
    return wx.Image(stream)
...
def getToolTreeCtrlBitmap():
    return wx.Bitmap(getToolTreeCtrlImage())

def getToolTreeCtrlImage():
    stream = BytesIO(getToolTreeCtrlData())
    return wx.Image(stream)
...
def getToolUnknownBitmap():
    return wx.Bitmap(getToolUnknownImage())

def getToolUnknownImage():
    stream = BytesIO(getToolUnknownData())
    return wx.Image(stream)
...
def getTreeDefaultBitmap():
    return wx.Bitmap(getTreeDefaultImage())

def getTreeDefaultImage():
    stream = BytesIO(getTreeDefaultData())
    return wx.Image(stream)
...
def getTreeDialogBitmap():
    return wx.Bitmap(getTreeDialogImage())

def getTreeDialogImage():
    stream = BytesIO(getTreeDialogData())
    return wx.Image(stream)
...
def getTreeFrameBitmap():
    return wx.Bitmap(getTreeFrameImage())

def getTreeFrameImage():
    stream = BytesIO(getTreeFrameData())
    return wx.Image(stream)
...
def getTreeMenuBitmap():
    return wx.Bitmap(getTreeMenuImage())

def getTreeMenuImage():
    stream = BytesIO(getTreeMenuData())
    return wx.Image(stream)
...
def getTreeMenuBarBitmap():
    return wx.Bitmap(getTreeMenuBarImage())

def getTreeMenuBarImage():
    stream = BytesIO(getTreeMenuBarData())
    return wx.Image(stream)
...
def getTreeMenuItemBitmap():
    return wx.Bitmap(getTreeMenuItemImage())

def getTreeMenuItemImage():
    stream = BytesIO(getTreeMenuItemData())
    return wx.Image(stream)
...
def getTreePanelBitmap():
    return wx.Bitmap(getTreePanelImage())

def getTreePanelImage():
    stream = BytesIO(getTreePanelData())
    return wx.Image(stream)
...
def getTreeRootBitmap():
    return wx.Bitmap(getTreeRootImage())

def getTreeRootImage():
    stream = BytesIO(getTreeRootData())
    return wx.Image(stream)
...
def getTreeSeparatorBitmap():
    return wx.Bitmap(getTreeSeparatorImage())

def getTreeSeparatorImage():
    stream = BytesIO(getTreeSeparatorData())
    return wx.Image(stream)
...
def getTreeSizerFlexGridBitmap():
    return wx.Bitmap(getTreeSizerFlexGridImage())

def getTreeSizerFlexGridImage():
    stream = BytesIO(getTreeSizerFlexGridData())
    return wx.Image(stream)
...
def getTreeSizerGridBitmap():
    return wx.Bitmap(getTreeSizerGridImage())

def getTreeSizerGridImage():
    stream = BytesIO(getTreeSizerGridData())
    return wx.Image(stream)
...
def getTreeSizerGridBagBitmap():
    return wx.Bitmap(getTreeSizerGridBagImage())

def getTreeSizerGridBagImage():
    stream = BytesIO(getTreeSizerGridBagData())
    return wx.Image(stream)
...
def getTreeSizerHBitmap():
    return wx.Bitmap(getTreeSizerHImage())

def getTreeSizerHImage():
    stream = BytesIO(getTreeSizerHData())
    return wx.Image(stream)
...
def getTreeSizerVBitmap():
    return wx.Bitmap(getTreeSizerVImage())

def getTreeSizerVImage():
    stream = BytesIO(getTreeSizerVData())
    return wx.Image(stream)
...
def getTreeStaticBoxSizerHBitmap():
    return wx.Bitmap(getTreeStaticBoxSizerHImage())

def getTreeStaticBoxSizerHImage():
    stream = BytesIO(getTreeStaticBoxSizerHData())
    return wx.Image(stream)
...
def getTreeStaticBoxSizerVBitmap():
    return wx.Bitmap(getTreeStaticBoxSizerVImage())

def getTreeStaticBoxSizerVImage():
    stream = BytesIO(getTreeStaticBoxSizerVData())
    return wx.Image(stream)
...
def getTreeToolBitmap():
    return wx.Bitmap(getTreeToolImage())

def getTreeToolImage():
    stream = BytesIO(getTreeToolData())
    return wx.Image(stream)
...
def getTreeToolBarBitmap():
    return wx.Bitmap(getTreeToolBarImage())

def getTreeToolBarImage():
    stream = BytesIO(getTreeToolBarData())
    return wx.Image(stream)
